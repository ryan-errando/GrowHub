...
<div class="container py-5">
    ...
    <a href="{{ route('user.orderProducts') }}" 
       class="nav-link {{ Request::is('orderProducts*') ? 'active' : '' }}" 
       style="color: {{ Request::is('orderProducts*') ? '#1b4332' : '#AAA' }}; 
              border-color: {{ Request::is('orderProducts*') ? '#1b4332' : 'transparent' }};">
        Product
    </a>
    <a href="{{ route('user.orderServices') }}" 
       class="nav-link {{ Request::is('orderServices*') ? 'active' : '' }}" 
       style="color: {{ Request::is('orderServices*') ? '#1b4332' : '#AAA' }}; 
              border-color: {{ Request::is('orderServices*') ? '#1b4332' : 'transparent' }};">
        Service
    </a>
</div>
